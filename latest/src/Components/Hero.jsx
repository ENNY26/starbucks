  ...
  <span className="inline-block">
    <img className="w-8 h-8 inline-block" src={cup} alt="cup icon" />
      ...
      <div className='flex items-center'>
        <img src={latte} alt="" 
        className='bg-gray-300 rounded-full max-w-9'/>
        <h3>Over 100 recipes <br /> available</h3>
      </div>
      <div className='flex items-center gap-2 '>
        <img src={iced} alt="" 
        className='bg-gray-300 rounded-full max-w-9'/>
        <h3>several categories to <br /> choose from</h3>
      </div>
      <div className='flex items-center gap-2 '>
        <img src={cup} alt="" 
        className='bg-gray-300 rounded-full max-w-9'/>
        <h3>recipe for both cold and <br />hot drinks</h3>
      </div>
      <div className='flex items-center gap-9 '>
        <img src={details} alt="" 
        className='bg-gray-300 rounded-full max-w-7'/>
        <h3>detailed step by step <br />instruction</h3>
      </div>
    </div>
      </div>
